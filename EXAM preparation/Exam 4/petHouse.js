function solveClasses() {
    ...
    class Cat extends Pet {
        ...
        toString() {
            ...
            let toPush = `${this.name} is a cat with ${this.insideHabits}`;
            if (this.scratching) {
                toPush += ', but beware of scratches.';
            }
            result.push(toPush);
            return result.join('\n');
        }
    ...
    class Dog extends Pet {
        ...
        toString() {
            ...
            result.push(super.toString());
            result.push('Main information:');
            let toPush = `${this.name} is a dog with need of ${this.runningNeeds}km running every day and ${this.trainability} trainability.`;
            result.push(toPush);
            return result.join('\n');
        }
    }
